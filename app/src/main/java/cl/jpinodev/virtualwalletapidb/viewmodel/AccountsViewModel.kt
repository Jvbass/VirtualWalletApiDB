...
class AccountsViewModel(private val accountUseCase: AccountsUseCase) : ViewModel() {
    ...
    private val _ownAccountsLDResponse = MutableLiveData<Result<Response<List<Accounts>>>>()
    ...
    val ownAccountsLDResponse: LiveData<Result<Response<List<Accounts>>>> = _ownAccountsLDResponse
